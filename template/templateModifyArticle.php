...
<head>
    ...
    <link href="/css/style_addarticle.css" rel="stylesheet">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="https://www.jeromesauvage.fr/other/cv_jerome_sauvage.pdf">Mon CV</a>
                </li>
                <li class="nav-item">
...
<div class="col-lg-8 col-md-10 mx-auto clearfix">
    <a class="btn btn-primary float-right" href="/">Retour aux articles </a>
</div>
<!-- Footer -->
<footer>
    <div class="container">
